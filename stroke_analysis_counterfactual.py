...
class StrokeCounterFactuals:
    ...
    def preprocess_dataset(self):
        simplified_dataset = self.healthcare_dataset.loc[:,['age', 'hypertension', 'heart_disease', 'avg_glucose_level',
    ...
    def counterfactual_generator_dice(self,model, dataset, input_datapoint):
        ...
        counterfactuals = explainer.generate_counterfactuals(input_datapoint, total_CFs=n_samples, desired_class = 'opposite',
